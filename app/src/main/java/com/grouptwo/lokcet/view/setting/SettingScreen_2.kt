...
import com.grouptwo.lokcet.view.register.PhoneNumberVisualTransformation
...
fun SettingScreen2(
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        Column(
            ...
            TextField(
                value = uiState.value.phoneNumberField,
                onValueChange = {
                ...
                placeholder = {
                    if (uiState.value.phoneNumberField.isEmpty()) Text(
            ...
            {
                if (uiState.value.isChangePhoneLoading) {
                    // Show loading icon
